# 🌍 BioWorld — AWS AI-Powered 3D Biology Learning Game

An interactive 3D biology learning game powered by **Amazon Bedrock (Nova Lite)**, **AWS DynamoDB**, and a React + Three.js frontend. Students upload biology PDFs, which are analyzed by AI to generate interactive 3D simulations and adaptive quizzes.
...
| Service | Purpose |
|---|---|
| **Amazon Bedrock (Nova Lite)** | Topic extraction from PDFs, 3D world generation, quiz generation |
| **Amazon DynamoDB** | User accounts, XP scores, quiz activity history |
...
├── bioworld_glb_2x.html   # Main 3D Bioworld game (Three.js)
...
2. **Upload a Biology PDF** — Bedrock extracts the top 6 topics
